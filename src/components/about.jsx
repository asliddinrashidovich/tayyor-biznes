...
function About() {
  return (
    <section className="w-full py-[50px]">
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 items-center justify-center gap-[40px]">
            <div className="rounded-[20px]  overflow-hidden flex justify-center">
                <Image src={'/pexels-fauxels-3184287.jpg'} alt="group image" width={400} className="rounded-[20px]" height={600}/>
            </div>
            <div>
                <p className="mb-[20px]">Siz Tadbirkorlikni Boshlamoqchimisiz? Lekin qanday boshlashni bilmaysiz. <br /> Sizga albatta biznes reja kerak. Biz sizga yordam beramiz <br /> <br />Biznesingiz muvaffaqiyati — puxta rejalashtirishdan boshlanadi.
