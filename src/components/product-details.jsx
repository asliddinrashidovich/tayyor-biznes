...
function PlanDetails({product}) {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button onClick={() => handleClick('/mahsulotlar')} className="text-center w-[200px] mb-[30px] inline-block bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700 cursor-pointer">Orqaga</button>
